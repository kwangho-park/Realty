...
-- Spring batch meta-data table (6ea)
-- Spring batch 5 동작 조건 : mariaDB 10.3 이상 필요)
-- spring batch ddl ref : https://github.com/spring-projects/spring-batch/blob/main/spring-batch-core/src/main/resources/org/springframework/batch/core/schema-mysql.sql
