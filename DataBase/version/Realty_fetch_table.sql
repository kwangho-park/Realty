...
ALTER TABLE TB_AREA_TYPE DROP FOREIGN KEY fk_TB_AREA_TYPE_TB_APT_BUILDING;

ALTER TABLE realty.TB_APT_BUILDING MODIFY COLUMN AB_PNU VARCHAR(20);
ALTER TABLE realty.TB_AREA_TYPE MODIFY COLUMN AT_AB_PNU VARCHAR(20);

ALTER TABLE realty.TB_AREA_TYPE
    ADD CONSTRAINT fk_TB_AREA_TYPE_TB_APT_BUILDING
        FOREIGN KEY (AT_AB_PNU) REFERENCES TB_APT_BUILDING(AB_PNU);
